...
// import other annotations as needed
...
public class HotelReservationController {
	...
	public String processRegistrationForm(@Valid @ModelAttribute("newUser") UserDto userDto,
	...
	public String newReservation(Model model) {
		...
		model.addAttribute("newRes", new ReservationDto());
	...
	public String proceedReservation(@Valid @ModelAttribute("newRes") ReservationDto reservationDto,
			BindingResult theBindingResult, Model model) {

		// send reservation to services to save it in database
		reservationService.saveOrUpdateReservation(reservationDto);
